System will output: [INFO] RAG Context Engine online.

> INIT_FRONTEND

Bash
# 1. Access the Client OS
cd frontend

# 2. Install Node packages
npm install

# 3. Ignite physics engine
npm run dev --turbo
Navigate browser to http://localhost:3000 to initiate uplink.
